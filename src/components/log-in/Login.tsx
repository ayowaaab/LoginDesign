...
const Login = () => {
  ...
  return (
    <>
      <div className="flex flex-col-reverse md:flex-row w-4/5 mx-auto justify-between items-center h-[50%] md:h-[100vh]">
        <div className="w-[100%] md:w-[50%] lg:w-[40%]">
          ...
          <div className="flex gap-2 flex-col">
            ...
            <Button handelClick={() => isLoading(true)} text="login" />
            {loading && <Alert />}
      ...
      <img
        className="absolute top-0 right-0 -z-10 h-[40vh] md:h-[100vh] md:w-auto md:rotate-0 w-full object-cover rotate-0"
        src="/img/login-bg-pc.svg"
        alt="login-bg"
      />
      <img
        className="absolute bottom-0 left-0 -z-10"
        src="/img/login-asba-1.svg"
        alt="asba-1"
      />
      <img
        className="absolute bottom-0 left-0 -z-20"
        src="/img/login-asba-2.svg"
        alt="asba-2"
      />
    </>
  );
